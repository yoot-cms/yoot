<script lang="ts">
	import { show_create_project } from '$lib/stores';
    import Loading from '../Loading.svelte';
    import { creating_project } from "../../../routes/(console)/console/projects/store"
</script>

{#if $show_create_project}
	<div class=" absolute h-screen w-full flex flex-col items-center justify-center bg-black/40">
