		...
		<header class="absolute inset-x-0 top-0 z-50">
			<nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
				...
				<div class="hidden lg:flex lg:gap-x-12">
					<a
						href="https://github.com/TheWisePigeon/yoot"
						target="_blank"
						rel="noreferrer"
						class="text-sm font-semibold leading-6 text-white">GitHub</a
					>
				</div>
			...
			<div class="lg:hidden" role="dialog" aria-modal="true">
				...
				<div
					class="fixed inset-y-0 right-0 z-50 w-full backdrop-blur-lg overflow-y-auto px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10"
				>
					...
					<div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
						...
						<div class="text-center">
							...
							<p class="mt-6 text-lg leading-8 text-gray-300">
								A minimalistic CMS focused on simplicity and ease of use.
							</p>
							<div class="mt-10 flex items-center justify-center gap-x-6">
								<a
									href="https://docs.yootcms.xyz"
									rel="noreferrer"
									target="_blank"
									...
									>Documentation</a
								>
								<a href="/console" class="text-sm font-semibold leading-5 text-white"
				...
				<div class="mx-auto max-w-7xl px-6 lg:px-8">
					<div class="mx-auto max-w-2xl sm:text-center">
						...
						<p class="mt-6 text-lg leading-8 text-gray-600">
							YOOT offers a user friendly web dashboard that you can use to store and manage your
							data, but also a simple to use REST API that exposes access to that data from anywhere
							you can make an HTTP request from
						</p>
					</div>
				</div>
						...
						<div class="relative pl-9">
							<dt class="inline font-semibold text-gray-900">
								<svg
									...
									class="absolute left-1 top-1 h-6 w-6 text-blue-600 fill-current"
									viewBox="0 0 256 256"
									><path
							...
							<dd class="inline">
								With YOOT console, manage your data on a user friendly interface
							</dd>
						</div>
						<div class="relative pl-9">
							<dt class="inline font-semibold text-gray-900">
							...
							<dd class="inline">
								Create secure keys with specific permissions on your projects and share these keys
								with developers you work with
							</dd>
						</div>
						<div class="relative pl-9">
							<dt class="inline font-semibold text-gray-900">
							...
							<dd class="inline">
								Get access to your data from anywhere you can make an HTTP request from. Our simple
								REST API let's you integrate YOOT seamlessly to all your apps
							</dd>
						</div>
					</dl>
				</div>
			...
			<div class="relative isolate mt-32 bg-white px-6 sm:mt-56 lg:px-8">
				...
				<div class="mx-auto max-w-2xl text-center lg:max-w-4xl">
					...
					<p class="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
						YOOT is free to use with some limitations.
					</p>
				</div>
				<p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
					We just launched, and paid plans are the last thing we are thinking about right now. Feel
					free to use YOOT as you like.
				</p>
				<div
				...
				>
					...
					>
						<h3 id="tier-hobby" class="text-base font-semibold leading-7 text-blue-600">Basic</h3>
						<p class="mt-4 flex items-baseline gap-x-2">
							<span class="text-5xl font-bold tracking-tight text-gray-900">$0</span>
							<span class="text-base text-gray-500">/month</span>
						</p>
						<p class="mt-6 text-base leading-7 text-gray-600">
							Get started with Yoot today and tell us what you think
						</p>
						<ul class="mt-8 space-y-3 text-sm leading-6 sm:mt-10 text-gray-600">
							...
							<li class="flex gap-x-3 line-through">
								<svg
									class="h-6 w-5 flex-none text-blue-600"
									viewBox="0 0 20 20"
									fill="currentColor"
					...
					>
						<h3 id="tier-enterprise" class="text-base font-semibold leading-7 text-blue-400">
							Pro
						</h3>
						<p class="mt-4 flex items-baseline gap-x-2">
							<span class="text-5xl font-bold tracking-tight text-white">$TBD</span>
							<span class="text-base text-gray-400">/month</span>
						</p>
						<p class="mt-6 text-base leading-7 text-gray-300">
							Use YOOT at his full potential while supporting us
						</p>
						<ul class="mt-8 space-y-3 text-sm leading-6 sm:mt-10 text-gray-300">
							<li class="flex gap-x-3">
								<svg
						...
						<a
							...
							class=" mt-8 block rounded-md py-2.5 px-3.5 text-center text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 sm:mt-10 bg-blue-500 text-white shadow-sm hover:bg-blue-400 focus-visible:outline-blue-500"
							>Not available yet</a
						>
					</div>
				</div>
									...
									<ul class="mt-6 space-y-4">
										<li>
											<a
												...
												target="_blank"
												rel="noreferrer"
												class="text-sm leading-6 text-gray-300 hover:text-white">GitHub</a
											>
										</li>
										<li>
											<a
