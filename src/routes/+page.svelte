				...
				<div class="mx-auto max-w-7xl px-6 lg:px-8">
					<div class="mx-auto max-w-2xl sm:text-center">
						...
						<p class="mt-6 text-lg leading-8 text-gray-600">
							YOOT offers a user friendly web dashboard that you can use to manage and store any
							type of data.
						</p>
					</div>
				</div>
				...
				>
					...
					<div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
						<figure class="relative isolate pt-6 sm:pt-12">
							...
							>
								<p>
									For me YOOT takes away the pain I feel every time I have to build a simple CRUD
									system. I just slap the data in there and use the API to access it.
								</p>
							</blockquote>
							<figcaption class="mt-8 text-base">
								<div class="font-semibold text-white">
									<a href="https://github.com/TheWisePigeon" rel="noreferrer" target="_blank"
										>TheWisePigeon</a
									>
								</div>
								<div class="mt-1 text-gray-400">Yoot creator</div>
							</figcaption>
						</figure>
					</div>
				</div>
			...
			<div class="relative isolate mt-32 bg-white px-6 sm:mt-56 lg:px-8">
				...
				<div class="mx-auto max-w-2xl text-center lg:max-w-4xl">
					...
					<p class="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
						YOOT is free to use for now, with some limitations.
					</p>
				</div>
				<p class="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600">
					...
					free to use YOOT as you like. We will be updating this section asap
				</p>
				<div
