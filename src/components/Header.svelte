...
<main  >
    <header class="header" >
        <h1 class=" font-bold text-lg" >YOOT</h1> 
        <div class="flex gap-5" >
            <h1 class=" underline">Docs</h1>
            <h1 class=" underline">About</h1>
        </div>
    </header>
    <!-- Location indicator -->
    <div class="locationIndicator" >
        {#if location.includes("/containers")}
            <div class="locationIndicatorItem" >
        ...
        {/if}
        {#if location.includes("/ressources")}
            <div class="locationIndicatorItem" >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
...
<style>
    .header{
        @apply flex justify-between items-center p-2 border-b-2;
    }

    .locationIndicator{
        @apply  overflow-x-scroll flex p-2 border-b-2;
    }

    .locationIndicator::-webkit-scrollbar{
        @apply lg:hidden;
    }

    .locationIndicatorItem{
