...
<div class={`${$modal2State?"hidden":""} flex flex-col items-center justify-center text-2xl  h-screen w-full text-white z-10 top-0 left-0 absolute `} >
    <div class=" w-96 h-44 rounded-md p-2 bg-blue-500 space-y-5 flex flex-col shadow-xl shadow-blue-600" >
        ...
        <p class=" text-center" >Entity builder</p>
       <div class=" flex justify-center ">
